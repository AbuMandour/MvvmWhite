...
namespace WhiteMvvm.Services.DeviceUtilities
{
	...
	public class TextToSpeechService :  ITextToSpeech { 
        ...
        {
            return Xamarin.Essentials.TextToSpeech.SpeakAsync(text, cancelToken);
        }

        Task ITextToSpeech.SpeakAsync(string text, Xamarin.Essentials.SpeechOptions options, CancellationToken cancelToken)
