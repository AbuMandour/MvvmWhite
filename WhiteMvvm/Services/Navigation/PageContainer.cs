...
namespace WhiteMvvm.Services.Navigation
{
    public class PageContainer : NotifiedObject
    {
        ...
        public PageContainer(BaseViewModel viewModel, object parameter = null, 
            bool isNavigationPage = false, string pageName = "", 
            bool isMasterDetail = false,PageContainer masterContainer = null)
        {
            Parameter = parameter;
            ViewModel = viewModel;
        ...
        public PageContainer MasterContainer { get; set; }
    }
}
